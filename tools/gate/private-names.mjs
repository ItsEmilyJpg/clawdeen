...
const FORBIDDEN = [
  { name: 'notes', pattern: /notes/i, canary: 'Notes' },
  { name: 'examplecorp', pattern: /examplecorp/i, canary: 'ExampleCorp' },
  { name: 'tracker key', pattern: /\bSIN-\d+/i, canary: 'ABC-1234' },
  { name: 'private host', pattern: /[\w-]+\.hadik\.cz/i, canary: 'api.example.test' },
  { name: 'personal mailbox', pattern: /someone|@examplecorp\.cz/i, canary: 'someone@example.com' },
  { name: 'home directory', pattern: /\/Users\/hadik\b/, canary: '/Users/someone/dev' },
  { name: 'private platform', pattern: /deployhost|oldhost/i, canary: 'api.example.test' }
]
